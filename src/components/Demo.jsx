    ...
    <section className="mt-16 w-full max-w-xl">
        ...
        <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
          {allArticles.map((item, index) => (
            <div
              ...
              <p className="flex-1 font-satoshi text-blue-700 text-sm font-medium truncate">{item.url}</p>
            </div>
          ))}
        </div>
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        {isFetching ? (
          ...
          <p className="font-bold font-inter text-black text-cent">
            Well this was not supposed to happen...<br />
